function [DataOut_MeasurementTime,start_time, end_time] = DynamicalParameters_ChooseArea(DataToCrop, CroppingMethod)
% DynamicalParameters_ChooseArea Choosing area from the measurement file
