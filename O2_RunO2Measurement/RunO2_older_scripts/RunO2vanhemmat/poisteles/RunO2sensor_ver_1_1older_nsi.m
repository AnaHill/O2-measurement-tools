...
% Version 1.1 updates
   ...
   % Now during while loop, length of variables is only 1-
      % During loop, saving new line to .txt
clear, close all
...
% % %        % saving and drawing
% % %        phiM_(1)=phi; ampM_(1)=amp; pO2M_(1)=pO2;
...
% I) Piirtäisi aina gui-ikkunan, jossa näppäimet: Plot, stop, calibration changes
